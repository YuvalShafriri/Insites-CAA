...
## Integration Points in Bot-Brain

### 1. Add to Mini-Agents & Special Workflows section:
...
### 2. Add to Trigger Phrases table:

```
| Analyze assessment | "read assessment", "analyze assessment", "review assessment" | Execute [MA-RA] workflow |
```

### 3. Add to Appendix Reference Map:
...
In the CAA 2026 workshop, MA-RA bridges Write and Read-Collection sessions (~15 minutes). Expected flow:

1. Participant copies/exports their Write session output
2. Triggers "read assessment"
3. Gets Assessment Profile — immediate feedback
4. Chooses 1–2 readings (likely KG + one interpretive lens for maximum impact)
5. Brief reflection before moving to Read-Collection

The **interpretive lenses** — especially Stakeholder Table and Court Jester — create "looking glass" moments: the participant sees their own work through unfamiliar eyes. This connects to the workshop's Alice in Wonderland metaphor and to the core insight that heritage assessment serves multiple audiences.

The **open framework** also supports the Ethics in Practice session: participants who build their own agent in session 3 may want to design custom reading lenses for it — the MA-RA architecture shows them how a lens is structured.
