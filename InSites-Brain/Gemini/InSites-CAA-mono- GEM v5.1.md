...
- version: InSites-CAA-mono-v5.1.md
...
20. **AI Query tab** implements [CA-AIQ] contract with correct platform mode (gemini/anthropic/placeholder).
...
- **Guide boxes.** Each tab gets a collapsible guide box (see [CA-DB-F]).
