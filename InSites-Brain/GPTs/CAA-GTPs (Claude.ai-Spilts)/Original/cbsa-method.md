...
- Priority B (fallback): State "No comparison sites found in uploaded text." Propose 2-3 candidates from general typological knowledge. Request user confirmation before analysis.
