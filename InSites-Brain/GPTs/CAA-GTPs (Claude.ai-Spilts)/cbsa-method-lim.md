# CBSA Method — Complete Reference (LIM variant)
...
**LIM (Less-Is-More) variant** — reduced user-facing verbosity. See `less-is-more.md` for design rationale.
...
Every stage (1–6) must open with a brief that chains previous findings to the current task.

**Structure:**
1. Stage Title: `## #.x Content-Specific Title`
2. The Brief (block quote) — one paragraph with two parts:
   - **Why**: 1 sentence — what this stage does and why it matters now.
   - **How (arrows)**: 1-2 explicit mappings from previous-stage findings → current-stage logic. Use `→` arrows to show the chain.

> **💡 Brief:** [Why sentence.] [Finding A] → [current-stage logic]; [Finding B] → [current-stage logic].

**Rules:**
- The arrows are mandatory — they force chain-of-thought and show the user how stages connect.
...
- Anchor in specific content: The brief must reference concrete findings from the previous stage.

**Example (Stage 2 CSR Brief):**
> **💡 Brief:** With six contexts and a 1350–1920 timeline established, we now identify which cultural values these frameworks support. Social context (merchant gathering) → examining social value; Mamluk trade-route history → examining historical value.
...
Every stage (1-6) ends with this sequence:
1. **💡 For Reflection** — One or two site-specific questions.
2. **✋** Anything to add, correct, or change? Continue to Stage N?
3. **Status Line** — `─────` then `[icon] [stage name]`

Stage 0: Exempt from 💡 For Reflection. End with: ✋ Anything to add, correct, or change? Continue to Stage 1?
...
End with: ✋ Anything to add, correct, or change? Continue to Stage 1?
...
**💡 Brief (mandatory)**: Open with a brief referencing Stage 0 findings.
...
End with: 💡 For Reflection → ✋ Continue to Stage 2?
...
**💡 Brief (mandatory)**: Reference contexts and timeline from Stage 1.
...
End with: 💡 For Reflection → ✋ Continue to Stage 3?

---

## Stage 3️⃣ Authenticity and Integrity

**💡 Brief (mandatory)**: Reference Stage 2 value-attribute pairs (cite 1-3 key items).
...
Highlight authenticity dilemmas, losses, or reinforcing factors. Mention relevant regional heritage frameworks within the analysis when applicable.

End with: 💡 For Reflection → ✋ Continue to Stage 4?

---

## Stage 4️⃣ Comparison with Other Assets

**💡 Brief (mandatory)**: Reference Stage 3 integrity findings.
...
End with: 💡 For Reflection → ✋ Continue to Stage 5?

---

## Stage 5️⃣ Cultural Significance Statement

**💡 Brief (mandatory)**: Reference key elements from all previous stages.
...
### 5.2 Next Steps
Offer Knowledge Graph (see kg-spec.md). Other explorations — semiotic reading, alternative narrative framings, community/educational ideas — are available on request.

End with: 💡 For Reflection → ✋ Continue to Stage 6?

---

## Stage 6️⃣ Quality Check and Summary

**💡 Brief (mandatory)**: Reference Stage 5 statement and strengths/gaps throughout.
...
End with: 💡 For Reflection → ✋ Add/correct anything?
...
**END OF CBSA METHOD FILE (LIM variant)**
